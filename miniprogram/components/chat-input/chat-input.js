...
function init(page, opt) {
  ...
  // 初始化常用语对象
  _page.data.inputObj.extraObj.commonExpressions={};
  //
...
function initExtraData(extra$arr) {
  ...
  _page.chatInputExtraClickEvent = function() {
    // 设置是否隐藏常用语布局
    _page.data.inputObj.extraObj.commonExpressions.isShowExpressions = !_page.data.inputObj.extraObj.chatInputShowExtra == false ? false : true;
    _page.setData({
      'inputObj.extraObj.commonExpressions': _page.data.inputObj.extraObj.commonExpressions,
 ...
 * 初始常用语
 */
function initCommonExpressions(page, list) {
  _page = page;
  _page.data.inputObj.extraObj.commonExpressions.list=list;
  _page.setData({
    'inputObj.extraObj.commonExpressions': _page.data.inputObj.extraObj.commonExpressions
  });
}
 ...
 * 添加常用语
 */
function addcommonExpressionListener(cb){
  _page.addcommonExpression = typeof cb === "function" ? cb : null;
}
/**
 * 常用语监听事件
 */
function setCommonExpressionsListener(cb) {
  _page.commonexpressionItemClickEvent = typeof cb === "function" ? cb : null;
}

module.exports = {
  init: init,
  initCommonExpressions: initCommonExpressions,
  VRStatus: status,
  ...
  addcommonExpressionListener: addcommonExpressionListener,
  setExtraButtonClickListener: setExtraButtonClickListener,
  setVoiceRecordStatusListener: setVoiceRecordStatusListener,
  setCommonExpressionsListener: setCommonExpressionsListener
};