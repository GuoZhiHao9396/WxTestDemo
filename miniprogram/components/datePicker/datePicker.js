Component({
  ...
  attached: function () {
    ...
    for (let i = 1999; i <= date.getFullYear() + 5; i++) {
      years.push(i);
    }
  ...
  methods: {
    ...
    hour_onChange: function (e) {
      console.log("时", e.detail.value)
      this.setData({
        tempHourPos: e.detail.value
      });
    },
    minute_onChange: function (e) {
      console.log("分", e.detail.value)
      this.setData({
    ...
    getRefreshData() {
      ...
      var tempMinutePos = date.getMinutes() - 1;
